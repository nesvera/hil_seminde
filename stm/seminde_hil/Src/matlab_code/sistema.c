...
void sistema_step(void)
{
  ...
  /* '<S12>:1:9' */
  /* '<S12>:1:12' */
  w1d_sq = (-sistema_U.Z_XPlane - (49189.6914F)) - sistema_U.referencias[0];				// (ORIGINAL) Z0 positivo
  u_phi = (sistema_U.X_XPlane - (3336.3452F)) - sistema_U.referencias[1];				// (ORIGINAL) X0 negativo
  ...
  /* '<S11>:1:30' */
  w1d_sq = (-sistema_U.Y_XPlane - (159.1640F)) - sistema_U.referencias[2]; 					// (ORIGINAL) Y0 positivo
